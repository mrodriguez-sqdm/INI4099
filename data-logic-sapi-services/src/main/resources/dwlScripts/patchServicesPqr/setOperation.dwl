...
(vars.pqrUpdateType) match {
	case "activity" -> {
		result: (payload.body.Set_PQR_ActividadesResponse.Set_PQR_ActividadesResult.WSResponseBody.OperationResult default 1) as Number,
	...
	case "characteristics" -> {
		result: (payload.body.Set_PQR_CaracteristicasResponse.Set_PQR_CaracteristicasResult.WSResponseBody.OperationResult default 1) as Number,
	...
	case "status" -> {
		result: (payload.body.Set_PQRResponse.Set_PQRResult.WSResponseBody.OperationResult default 1) as Number,
